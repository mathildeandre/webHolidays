...
-->
	<h2 id="h2Groupe" class="" onmouseover="changeCursor('h2Groupe')" onclick="location.href='index.jsp?page=group'">Group</h2>
                <p>The group of all people going in holidays with you. </br></p>
	<h2 id="h2Doodle" class="" onmouseover="changeCursor('h2Doodle')" onclick="location.href='index.jsp?page=doodle'">Doodle</h2>
	...
	<h2 id="h2Repas" class="" onmouseover="changeCursor('h2Repas')" onclick="location.href='index.jsp?page=homepage'">Meals</h2>
	...
	<h2 id="h2Calc" class="" onmouseover="changeCursor('h2Calc')" onclick="location.href='index.jsp?page=expenses'">Expenses</h2>
                <p> You can write all your expenses and then the service will calculate how much every body owes to every one. </p>
	<h2 id="h2Affaire" class="" onmouseover="changeCursor('h2Affaire')" onclick="location.href='index.jsp?page=things'">Things</h2>
	...
	<h2 id="h2Loisirs" class="" onmouseover="changeCursor('h2Loisirs')" onclick="location.href='index.jsp?page=hobbies'">Hobbies</h2>
