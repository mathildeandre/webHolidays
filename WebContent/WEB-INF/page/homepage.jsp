...
<div id="sousSectionHomepage">
    ...
    <article>
	 <h1 id="h1Homepage"  class="h1">Practical guide </h1> <!-- class="h1 text3Dfonce" -->
...
-->
	<h2 id="h2Groupe" class="" onmouseover="changeCursor('h2Groupe')" onclick="location.href='../groupe/groupe.html'">Group</h2>
                <p>The group of all people going in holidays with you. </br></p>
	<h2 id="h2Doodle" class="" onmouseover="changeCursor('h2Doodle')" onclick="location.href='../doodle/doodle.html'">Doodle</h2>
	...
	<h2 id="h2Repas" class="" onmouseover="changeCursor('h2Repas')" onclick="location.href='../repas/repas.html'">Meals</h2>
	...
	<h2 id="h2Calc" class="" onmouseover="changeCursor('h2Calc')" onclick="location.href='../calculation/calculation.html?tab=emiel,matthijs,fabian,kiki'">Expenses</h2>
                <p> You can write all your expenses and then the service will calculate how much every body owes to every one. </p>
	<h2 id="h2Affaire" class="" onmouseover="changeCursor('h2Affaire')" onclick="location.href='../affaire/affaire.html'">Things</h2>
	...
	<h2 id="h2Loisirs" class="" onmouseover="changeCursor('h2Loisirs')" onclick="location.href='../groupe/groupe.html'">Hobbies</h2>
