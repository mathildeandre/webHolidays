...
\definecolor{mygreen}{rgb}{0.10, 0.80, 0.1}
\definecolor{darkred}{rgb}{0.6, 0.10, 0.1}
\definecolor{lightred}{rgb}{0.9, 0.2, 0.2}



\newboxedtheorem[boxcolor=black, background=mygreen!60, titlebackground=darkgreen!60,titleboxcolor = black, thcounter=chapter]{madef}{D\'efinition}{compteurTH}
\renewcommand{\thecompteurTH}{\arabic{chapter}.\arabic{compteurTH}}

\newboxedtheorem[boxcolor=black, background=lightred!90, titlebackground=darkred!90,titleboxcolor = black, thcounter=chapter]{matheo}{Theoreme}{compteurTheo}
\renewcommand{\thecompteurTheo}{\arabic{chapter}.\arabic{compteurTheo}}

\newboxedtheorem[titlecolor=black, boxcolor=black, background=white, titlebackground=white,titleboxcolor = black, thcounter=chapter]{maprop}{Proposition}{compteurProp}
\renewcommand{\thecompteurProp}{\arabic{chapter}.\arabic{compteurProp}}
